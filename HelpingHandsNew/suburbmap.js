...
console.log("4");       
        ...
        d3.csv("melbourneEducation.csv", function(data) {
            postcode = {};
            edu = {};
        ...
        d3.csv("melbourneProvider.csv", function(data) {
            postcodePro = {};
            pro = {};
            for (var i = 0; i < data.length; i += 1) {
                // Have to replace the $ in the file
...
console.log("5");
        d3.csv("hrfees.csv", function(data) {
            qtile = {};
            postcodeHr = {};
            fee = {};
            for (var i = 0; i < data.length; i += 1) {
...
console.log("7");
        ...
        d3.json("MelSub.json", function(error, it) {
